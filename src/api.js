const API_URL = 'https://66a1cdc4cf4a919a61f8c5f9--group5cop4331.netlify.app/api';
...
export const login = async (email, password) => {
  ...
  const response = await fetch('https://66a1cdc4cf4a919a61f8c5f9--group5cop4331.netlify.app/api/auth/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export const createParty = async (partyName) => {
  const response = await fetch('https://66a1cdc4cf4a919a61f8c5f9--group5cop4331.netlify.app/api/party/create', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
